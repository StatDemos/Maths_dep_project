...
p2 <- ggplot(marks_data, aes(x=Total_Attendance, y=Grand_Final))+
  geom_point(aes(text = paste("Index No: ", Index_No, "<br>Attendance: " , Total_Attendance,"<br>Grand final mark: ", Grand_Final)))+  geom_smooth(method=lm , color="red", se=FALSE, aes(text = paste("Pearson Correlation: 0.43 " ))) +
  labs(
    x = "Total Attendance",
    y = "Grand final exam marks") +
   labs(
       x = "Total attendance",
       y = "Grand final exam marks")  + scale_x_continuous(limits = c(0, 7), breaks = 0:7)
...
p3 <- ggpairs(marks_data, columns = c("Mid_34", "Marks_2", "Grand_Final", "Total_Attendance"),
